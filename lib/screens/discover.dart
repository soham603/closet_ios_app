...
class _DiscoverState extends State<Discover> {
  Future<List<Map<String, dynamic>>> getAllOutfits() async {
    QuerySnapshot<Map<String, dynamic>> outfitsSnapshot = await FirebaseFirestore.instance.collectionGroup('outfits').get();
              ...
              builder: (context, snapshot) {
                ...
                return GridView.builder(
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    ...
                    mainAxisSpacing: 8.0,
                    //childAspectRatio: 3 / , use mediaquery
                    childAspectRatio: mediaQueryData.size.width / (mediaQueryData.size.height / 1.6),
                  ),
